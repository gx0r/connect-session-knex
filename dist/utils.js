...
export const isMySQL = (knex) => ["mysql", "mariasql", "mariadb"].indexOf(knex.client.dialect) > -1;
export const isMSSQL = (knex) => ["mssql"].indexOf(knex.client.dialect) > -1;
export const isPostgres = (knex) => ["postgresql"].indexOf(knex.client.dialect) > -1;
export const isOracle = (knex) => ["oracle", "oracledb"].indexOf(knex.client.dialect) > -1;
/*
